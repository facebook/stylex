...
- We would need to have code generation step to give you type safety.
- We would need more complication validation logic.
- We would need map CSS syntax to StyleX concepts.
