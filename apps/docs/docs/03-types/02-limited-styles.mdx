...
# Accepting a specific set of styles
...
It is usually a good practice to make the keys of the style types optional.
However, there might be situations where you can require some styles to be
passed in.
