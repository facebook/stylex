...
* Customization / Props / Styles merging
-->
...
**Strings don't have Types**. By using JavaScript objects for styles, we retain type information when you define styles.
