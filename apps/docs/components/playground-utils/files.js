...
export default function App() {
  ...
  return (
    <>
      <div>
        <a {...props(s.link)} href="https://vite.dev" target="_blank">
          <img {...props(s.logo)} src={viteLogo} alt="Vite logo" />
        </a>
        <a {...props(s.link)} href="https://react.dev" target="_blank">
          <img
            {...props(s.logo, s.logoReact)}
            src={reactLogo}
            alt="React logo"
          />
        </a>
        <a {...props(s.link)} href="https://stylexjs.com" target="_blank">
          <StyleXLogo style={s.logo} />
        </a>
      </div>

      <h1 {...props(s.h1)}>Vite + React</h1>
      <div {...props(s.card)}>
        <button
          {...props(s.button)}
