...
export const styles = stylex.create({
  ...
  cardSmall: {
    borderRadius: spacing.border.radius.small,
    gap: spacing.gap.small,
    margin: spacing.margin.small,
    padding: spacing.padding.small,
    paddingBlock: spacing.padding.tiny,
    paddingInline: spacing.padding.medium,
  },
  cardLarge: {
    borderRadius: spacing.border.radius.xLarge,
    gap: spacing.gap.large,
    margin: spacing.margin.large,
    padding: spacing.padding.xLarge,
    paddingBlock: spacing.padding.large,
    paddingInline: spacing.padding.xLarge,
  },
  icon: {
    height: spacing.icon.size.medium,
    margin: spacing.margin.tiny,
    width: spacing.icon.size.medium,
  },
  iconSmall: {
    height: spacing.icon.size.small,
    margin: spacing.margin.tiny,
    width: spacing.icon.size.small,
  },
  iconLarge: {
    height: spacing.icon.size.large,
    margin: spacing.margin.small,
    width: spacing.icon.size.large,
  },
  input: {
    borderRadius: spacing.border.radius.medium,
    height: spacing.input.height.medium,
    margin: spacing.margin.small,
    padding: spacing.padding.small,
    paddingBlock: spacing.padding.tiny,
    paddingInline: spacing.padding.medium,
  ...
  inputSmall: {
    borderRadius: spacing.border.radius.small,
    height: spacing.input.height.small,
    margin: spacing.margin.tiny,
    padding: spacing.padding.tiny,
    paddingBlock: spacing.padding.tiny,
    paddingInline: spacing.padding.small,
  },
  inputLarge: {
    borderRadius: spacing.border.radius.large,
    height: spacing.input.height.large,
    margin: spacing.margin.medium,
    padding: spacing.padding.medium,
    paddingBlock: spacing.padding.small,
    paddingInline: spacing.padding.large,
  },
  container: {
    borderRadius: spacing.border.radius.medium,
    ...
    margin: spacing.margin.medium,
    padding: spacing.padding.medium,
    width: spacing.container.width.medium,
  },
  containerSmall: {
    borderRadius: spacing.border.radius.small,
    ...
    margin: spacing.margin.small,
    padding: spacing.padding.small,
    width: spacing.container.width.small,
  },
  containerLarge: {
    borderRadius: spacing.border.radius.xLarge,
    gap: spacing.gap.large,
    margin: spacing.margin.xLarge,
    padding: spacing.padding.xLarge,
    width: spacing.container.width.large,
  },
  badge: {
    borderRadius: spacing.border.radius.small,
    gap: spacing.gap.tiny,
  ...
  header: {
    ...
    gap: spacing.gap.medium,
    margin: spacing.margin.medium,
    marginBlockEnd: spacing.margin.large,
    padding: spacing.padding.large,
    paddingBlock: spacing.padding.medium,
    paddingInline: spacing.padding.large,
  },
  footer: {
    ...
    gap: spacing.gap.medium,
    margin: spacing.margin.medium,
    marginBlockStart: spacing.margin.large,
    padding: spacing.padding.large,
    paddingBlock: spacing.padding.medium,
    paddingInline: spacing.padding.large,
  },
