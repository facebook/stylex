...
const shorthandAliases: $ReadOnly<{
  ...
  borderInlineEnd: createSpecificTransformer('border-inline-end'),
  borderInlineStart: createSpecificTransformer('border-inline-start'),
  borderBlockEnd: createSpecificTransformer('border-block-end'),
  borderBlockStart: createSpecificTransformer('border-block-start'),
  borderInline: createSpecificTransformer('border-inline'),
  borderBlock: createSpecificTransformer('border-block'),
  borderInlineColor: createSpecificTransformer('border-inline-color'),
  borderInlineStyle: createSpecificTransformer('border-inline-style'),
  borderInlineWidth: createSpecificTransformer('border-inline-width'),
  borderBlockColor: createSpecificTransformer('border-block-color'),
  borderBlockStyle: createSpecificTransformer('border-block-style'),
  borderBlockWidth: createSpecificTransformer('border-block-width'),
  ...
  placeContent: createSpecificTransformer('place-content'),
  placeItems: createSpecificTransformer('place-items'),
  placeSelf: createSpecificTransformer('place-self'),
  columnRule: createSpecificTransformer('column-rule'),
  columns: createSpecificTransformer('columns'),
  listStyle: createSpecificTransformer('list-style'),
  caret: createSpecificTransformer('caret'),
