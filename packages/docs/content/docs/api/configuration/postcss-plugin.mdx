...
Setting `include` turns off auto-discovery. List your own source files and any
dependencies that ship StyleX source, including paths inside `node_modules`.
Auto-discovery only checks direct dependencies, not their dependencies.
