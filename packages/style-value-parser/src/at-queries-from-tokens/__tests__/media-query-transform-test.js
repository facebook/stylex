...
describe('Media Query Transformer', () => {
  ...
  test('handles and media queries', () => {
    ...
    const expectedStyles = {
      container: {
        default: 'width:100%',
        '@media (min-width: 900px) and (not (max-height: 300px)) and (not (max-width: 899px)) and (not (min-width: 500px))':
          'width:80%',
        '@media (min-width: 500px) and (max-width: 899px) and (max-height: 300px)':
          'width:50%',
      },
  ...
  test('combination of keywords and rules', () => {
    ...
    const expectedStyles = {
      container: {
        default: 'width:100%',
        '@media screen and (min-width: 900px) and (not (max-width: 500px)) and (not print)':
          'width:80%',
        '@media print and (max-width: 500px)': 'width:50%',
      },
    };
