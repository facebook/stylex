  ...
  it('extracts CSS and removes stylex.inject calls', async () => {
    ...
    for (const chunkOrAsset of output) {
      if (chunkOrAsset.fileName === 'stylex.css') {
        expect(chunkOrAsset.source).toMatchInlineSnapshot(`
      ...
      if (chunkOrAsset.fileName === 'bundle.js') {
        expect(chunkOrAsset.code).toMatchInlineSnapshot(`
          ...
          function App() {
            return stylex(styles$1.bar, styles.foo);
          }
